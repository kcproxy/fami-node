...
import (
	...
	"github.com/kcproxy/fami-node/conf"
	"github.com/kcproxy/fami-node/core"
	"github.com/kcproxy/fami-node/limiter"
	"github.com/kcproxy/fami-node/node"
...
func init() {
	serverCommand.PersistentFlags().
		StringVarP(&config, "config", "c",
			"/etc/fami-node/config.yml", "config file path")
	serverCommand.PersistentFlags().
